...
<div class="container" align="left" style="width: 100%; max-width: 900px; margin: 0 auto;">
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-md-6 form-group">
                    ...
                    <input type="text" name="date_creation" id="date_creation" value="{{ $candidat->created_at }}" class="form-control" disabled>
                </div>
                <div class="col-md-6 form-group">
                    <label for="derniere_modification">Dernière Modification</label>
                    <input type="text" name="derniere_modification" id="derniere_modification" value="{{ $candidat->updated_at }}" class="form-control" disabled>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="form-group text-center" style="margin-top: 30px; margin-bottom: 40px;">
        <a href="{{url('/candidats/modify',['id'=>$candidat->id_candidat])}}" class="btn btn-submit-blue"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Éditer mon profil</a>
    </div>
</div>
